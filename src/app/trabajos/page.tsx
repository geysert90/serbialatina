...
export const metadata: Metadata = {
  title: "Trabajos",
  description:
    "Ofertas laborales para la comunidad hispana en Serbia. Busca por ciudad y palabras clave.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Explora oportunidades laborales en Serbia. Busca por ciudad y palabras clave.",
      ...
      <div className="panel overflow-hidden p-6 md:p-8">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)] lg:items-end">
          <div className="space-y-5">
            <div className="eyebrow w-fit">Ofertas laborales</div>
            <div className="space-y-4">
              ...
              <p className="max-w-3xl text-lg leading-8 text-black/65">
                Ofertas laborales actualizadas para la comunidad hispana. Por defecto se muestran las
                más recientes. Puedes filtrar por ciudad y por palabras clave para encontrar lo que buscas.
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-black/55">
            {keywords ? (
              ...
              <>
                Últimas ofertas en <strong>{locationLabel}</strong>
              </>
            )}
          </p>
        </div>
      ...
      {result.jobs.length > 0 ? (
        ...
        <div className="reserved-slot min-h-[280px]">
          ...
          <p className="mt-auto max-w-2xl text-sm leading-7 text-black/55">
            No encontramos ofertas para esta búsqueda. Prueba con otras
