    ...
    <section className="panel overflow-hidden p-5 md:p-6">
      <div className="flex flex-col gap-4 border-b border-black/8 pb-5 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <p className="max-w-xl text-sm leading-6 text-black/55">
            Últimas ofertas laborales para <strong>{locationLabel}</strong>, ordenadas por fecha de publicación con descripciones traducidas al español.
          </p>
          <Link
            href="/trabajos"
      ...
      {result.error ? (
        ...
        <div className="mt-6 snap-x overflow-x-auto pb-4 [scrollbar-width:thin]">
          <div className="grid grid-flow-col grid-rows-2 gap-4 [grid-auto-columns:minmax(260px,82%)] md:[grid-auto-columns:calc((100%_-_2rem)/3)]">
            {result.jobs.map((job) => (
        ...
        <div className="reserved-slot mt-5 min-h-[220px]">
          ...
          <p className="mt-auto max-w-2xl text-sm leading-7 text-black/55">
            No encontramos ofertas laborales para la búsqueda actual. Prueba con otros
...
export default async function Home() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl flex flex-col gap-10 px-4 py-6 md:px-8 md:py-10 overflow-x-hidden">
        ...
        <div className="panel p-5 md:p-6">
          <div className="flex flex-col gap-3 border-b border-black/8 pb-5 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-2xl text-sm leading-6 text-black/55">
              Las noticias más recientes de la comunidad hispana en Serbia y los Balcanes.
            </p>
          </div>
