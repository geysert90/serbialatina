...
const WORDPRESS_API_BASE = (
  ...
  "https://admin.serbialatina.com/wp-json"
).replace(/\/$/, "");
...
const HOME_SECTION_BLUEPRINT = [
  {
    slug: "noticias",
    label: "Noticias",
    description: "Actualidad, análisis y contexto para la comunidad hispana en Serbia.",
    accent: "Actualidad",
  },
  {
    slug: "comunidad",
...
function getFallbackSiteIdentity(): SiteIdentity {
  return {
    name: "Serbia Latina",
    description: "Noticias, comunidad, trabajos y tienda para latinos en Serbia.",
    url: "https://admin.serbialatina.com",
    home: "https://admin.serbialatina.com",
  };
}
...
export async function getSiteIdentity(): Promise<SiteIdentity> {
  ...
  return {
    ...
    description: root.description || "Noticias, comunidad, trabajos y tienda para latinos en Serbia.",
      ...
      showcaseCategories.map(async (category) => {
        ...
        return {
          ...
          description:
            ...
            `Explora lo último de ${category.name} en la comunidad.`,
          posts,
