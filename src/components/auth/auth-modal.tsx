  ...
  return (
    <>
      <a
        ...
        className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-black/10 bg-white/76 text-black shadow-[0_12px_30px_-22px_rgba(0,0,0,0.7)] transition active:scale-95 hover:bg-white touch-manipulation sm:h-auto sm:w-auto sm:gap-3 sm:rounded-full sm:px-2 sm:py-2"
        aria-haspopup="dialog"
        aria-expanded={isOpen}
      >
        <span className="flex h-7 w-7 items-center justify-center rounded-full border border-black/8 bg-[rgba(209,91,31,0.1)] text-[var(--color-accent)] sm:h-10 sm:w-10">
          <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
            className="h-5 w-5"
