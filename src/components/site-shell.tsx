...
function UserAccessButton({
  ...
  return (
    <details className="group relative">
      <summary
        className="inline-flex h-12 w-12 cursor-pointer list-none items-center justify-center rounded-full border border-black/10 bg-white/76 text-black shadow-[0_12px_30px_-22px_rgba(0,0,0,0.7)] transition hover:-translate-y-0.5 hover:bg-white focus:bg-white focus:outline-none sm:h-auto sm:w-auto sm:gap-3 sm:rounded-full sm:px-2 sm:py-2 [&::-webkit-details-marker]:hidden"
  ...
  return (
    <div className="relative isolate min-h-screen">
      ...
      <header className="sticky top-0 z-50 border-b border-black/6 bg-[rgba(245,239,226,0.82)] backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-1.5 px-3 py-2.5 md:gap-4 md:px-8 md:py-4">
          <Link href="/" className="flex shrink-0 items-center gap-1.5 md:gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="hidden whitespace-nowrap text-[0.58rem] leading-tight text-black/65 sm:block md:text-sm">
