      ...
      <div className="space-y-3">
        ...
        <p className="text-sm leading-6 text-black/60">
          {category.description?.trim() ||
            `Noticias, artículos y recursos sobre ${category.name}.`}
        </p>
      </div>
      <div className="mt-auto pt-2">
    ...
    <article className="panel flex h-full items-center gap-4 p-4">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-black/55">
          {author.description?.trim() || "Autor de la comunidad Serbia Latina."}
        </p>
      </div>
    </article>
  );
...
export function EmptyCollection({
  ...
  return (
    <div className="panel flex min-h-[220px] flex-col justify-between gap-4 p-6">
      <div className="space-y-3">
        <div className="eyebrow w-fit">Contenido pendiente</div>
